...
export default function TemplateCard(template: TemplateProps) {
    return (
        <Link href={`/dashboard/section/content/template/${template.slug}`}>
            <div className=" flex flex-col gap-y-5 border-2 text-black bg-zinc-600  h-64 drop-shadow-2xl rounded-lg p-5 hover:scale-110 transition-all duration-500 ease-in-out cursor-pointer">
